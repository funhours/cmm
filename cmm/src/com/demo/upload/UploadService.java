...
public class UploadService {
	 ...
	 * ueditor 上传业务方法
	 */
	public Ret ueditorUpload( String uploadType, UploadFile uf) {
		...
		buildPathAndFileName(uploadType, 1234567890, extName, relativePathFileName, absolutePathFileName, fileName);
