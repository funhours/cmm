 ...
 * Author IIInsomnia
 * 
 * var cityPicker = new HzwCityPicker({ data: data, 城市数据 target: 'cityChoice',
 * 目标元素id（如：文本框，该值为城市名称） valType: 'k-v', 隐藏域的值类型（取值有：'k' => 只存ID，'k-v' =>
 * 存ID和名称，格式为：id-name） hideCityInput: { 城市隐藏域 name: 'city', 隐藏域name id: 'city'
 * 隐藏域id val: '2' 默认值 }, hideProvinceInput: { 省份隐藏域（如果不需要存省份，此项可以省略） name:
 * 'province', 隐藏域name id: 'province' 隐藏域id val: '1' 默认值 }, callback:
 * function(){ 回调函数，选择城市后调用 alert('OK'); } });
 * 
 * cityPicker.init();
 */
